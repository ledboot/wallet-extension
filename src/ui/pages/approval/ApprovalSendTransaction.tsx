    ...
    <ApprovalLayout id={id} onInit={setRequest}>
      <div className="flex flex-col h-screen bg-white text-gray-900 overflow-hidden">
        <div className="flex items-center justify-center h-16 border-b border-gray-50">
          <h1 className="text-lg font-bold">Send Transaction</h1>
        </div>
        ...
        <div className="flex-1 flex flex-col px-6 overflow-hidden">
          ...
          <div className="flex-1 flex flex-col min-h-0">
            <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2 shrink-0">Confirm details</p>
        ...
        <div className="p-6 border-t border-gray-100 shrink-0">
          <div className="flex items-center space-x-3 mb-6 px-1">
            ...
            <p className="text-[11px] leading-relaxed text-gray-500 font-semibold">
              This transaction will be broadcasted to the network and cannot be undone.
            </p>
          </div>
...
export default ApprovalSendTransaction;
